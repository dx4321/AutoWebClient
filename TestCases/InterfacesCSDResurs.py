...
try:
    ...
    Channels.add_channels(ChannelsLocators.add_csdresursgsm, ChannelsLocators.in_tree_csdresursgsm, "[CSD] Ресурс-GSM Модем")
    Interfaces.add_interfaces(ChannelsLocators.in_tree_csdresursgsm)
