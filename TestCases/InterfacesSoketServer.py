...
try:
    ...
    Channels.add_channels(ChannelsLocators.add_soketserver, ChannelsLocators.in_tree_soketserver, "[Ethernet] Socket Server (TELEOFIS)")
    Interfaces.add_interfaces(ChannelsLocators.in_tree_soketserver)
